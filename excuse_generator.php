...
<html>
  ...
  <body>
    <img src="Apology generator.png" alt="Logo" class="logo">
    ...
    <?php
      ...
      function generateExcuse($child_name, $child_gender, $teacher_name, $excuse_reason) {
        ...
        if (count($apologies) > 0) {
          ...
          return nl2br(htmlspecialchars($excuse)); // nl2br =>Convertit les sauts de ligne en balises <br> htmlspecialchars => échappe les caractères spéciaux
        } else {
